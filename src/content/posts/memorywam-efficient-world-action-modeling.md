...
![MemoryWAM 总体架构](/papers/2606.20562/architecture.png)
...
![Attention Mask](/papers/2606.20562/attention_mask.png)
...
![真实世界任务](/papers/2606.20562/realworld_tasks.png)

> **Figure 5**: 真实世界任务展示。左：Shell Game（寻找被移动的小方块）；右：Look and Press（观察数字并按对应次数按键）。

![硬件设置](/papers/2606.20562/hardware_setup.png)
